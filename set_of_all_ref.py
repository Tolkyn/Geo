...
def ref_po_st_10(**context):
    ...
    cnxn.execute('TRUNCATE TABLE gs.dbo.ref_po_st')
...
def ref_amendm_agreem_justf_14(**context):
    ...
    cnxn.execute('TRUNCATE TABLE gs.dbo.ref_amendm_agreem_justif')
...
def ref_amendm_agreem_type_15(**context):
    ...
    cnxn.execute('TRUNCATE TABLE gs.dbo.ref_amendment_agreem_type')
